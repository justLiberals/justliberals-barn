...
module.exports = function(config) {
  // Copy over images
  config.addPassthroughCopy({"websites/aldes_org_uk/images": "assets/images"});
  ...
  config.setBrowserSyncConfig({
    ...
    callbacks: {
      ready: (err, bs) => {
        const content_404 = fs.readFileSync(".output/websites/aldes_org_uk/error.html");
  ...
  config.addWatchTarget("websites/aldes_org_uk/scss/");

  // Eleventy configuration
  return {
    dir: {
      input: "websites/aldes_org_uk",
      output: ".output/websites/aldes_org_uk"
    },
